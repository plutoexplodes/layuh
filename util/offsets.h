...
// Roblox Version: version-8afc5a7d5e894d22

namespace offsets {
    inline constexpr uintptr_t AbsoluteSize = 0x120;
    ...
    inline constexpr uintptr_t BasePartColor = 0x1C4;
    inline constexpr uintptr_t BasePartPosition = 0x154;
    inline constexpr uintptr_t BasePartSize = 0x23C;
    ...
    inline constexpr uintptr_t CameraFOV = 0x168;
    inline constexpr uintptr_t CameraFocus = 0x130;
    inline constexpr uintptr_t CameraHeadScale = 0x170;
    ...
    inline constexpr uintptr_t CameraPosition = 0x124;
    ...
    inline constexpr uintptr_t ChildSize = 0x8;
    ...
    inline constexpr uintptr_t ColorShiftBottom = 0xF8;
    inline constexpr uintptr_t ColorShiftTop = 0xEC;
    inline constexpr uintptr_t CreatorId = 0x190;
    inline constexpr uintptr_t CurrentCamera = 0x450;
    inline constexpr uintptr_t DataModelDeleterPointer = 0x70A86C0;
    ...
    inline constexpr uintptr_t FakeDataModelPointer = 0x70A86B8;
    inline constexpr uintptr_t FakeDataModelToDataModel = 0x1C0;
    inline constexpr uintptr_t FakeDataModelToRealDataModel = 0x1C0;
    ...
    inline constexpr uintptr_t FramePosX = 0x4B0;
    inline constexpr uintptr_t FramePosY = 0x4B8;
    ...
    inline constexpr uintptr_t JobsPointer = 0x7171418;
    ...
    inline constexpr uintptr_t LocalTransparencyModifier = 0xF0;
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x711ba24;
    ...
    inline constexpr uintptr_t PlayerConfigurerPointer = 0x70861F0;
    ...
    inline constexpr uintptr_t Print = 0x150AEA0;
    ...
    inline constexpr uintptr_t RenderToEngine = 0x10;
    ...
    inline constexpr uintptr_t ToolGripPosition = 0x46C;
    ...
    inline constexpr uintptr_t VisualEnginePointer = 0x6E061B0;
    ...
    inline constexpr uintptr_t WalkSpeedA = 0x1DC;
    inline constexpr uintptr_t WalkSpeedB = 0x3B8;
